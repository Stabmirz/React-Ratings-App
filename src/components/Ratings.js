...
class Ratings extends Component {
    ...
    if (type === "checkbox") {
      if (checked) {
        ...
        this.setState({
          ...
          productStandouts: this.state.productStandouts.filter(
            (productStandout) => productStandout !== value
          ),
        });
      }
    } else {
  ...
  handleSubmit = (event) => {
    ...
    errors.experience =
      experience.length === 0 ? "Please select a rating!" : "";
              ...
              >
                <div className="container">
                  <div className="rating-container margin-medium">
                    <span
                      className={
                        this.state.errors.quality.length > 0
                          ? "empty-field"
                          : ""
                      }
                    >
                    ...
                    <div className="rating">
                      <fieldset>
                        <input
                          ...
                          value="5"
                        />
                        <label htmlFor="q5" title="Outstanding">
                          5
                        </label>
                        ...
                        <input
                          ...
                          value="4"
                        />
                        <label htmlFor="q4" title="Very Good">
                          4
                        </label>
                        <div className="hr-line"></div>
                        ...
                        <input
                          ...
                          value="1"
                        />
                        <label htmlFor="q1" title="Very Poor">
                          1
                        </label>
                      </fieldset>
                    </div>
                    ...
                    {errors.quality.length > 0 && (
                      <span className="error">{errors.quality}</span>
                    )}
                  </div>
                  <div className="rating-container margin-medium">
                    <span
                      className={
                        this.state.errors.design.length > 0 ? "empty-field" : ""
                      }
                    >
                      Design
                    </span>
                    <div className="rating">
                      <fieldset>
                        <input
                          ...
                          value="5"
                        />
                        <label htmlFor="d5" title="Outstanding">
                          5
                        </label>
                        <div className="hr-line"></div>
                        ...
                        <input
                          ...
                          value="4"
                        />
                        <label htmlFor="d4" title="Very Good">
                          4
                        </label>
                        <div className="hr-line"></div>
                        ...
                        <input
                          ...
                          value="1"
                        />
                        <label htmlFor="d1" title="Very Poor">
                          1
                        </label>
                      </fieldset>
                    </div>
                    <Text />
                    {errors.design.length > 0 && (
                      <span className="error">{errors.design}</span>
                    )}
                  </div>
                  ...
                  <div className="rating-container margin-large">
                    <span
                      className={
                        this.state.errors.experience.length > 0
                          ? "empty-field"
                          : ""
                      }
                    >
                    ...
                    <div className="rating">
                      <fieldset>
                        <input
                          ...
                          value="5"
                        />
                        <label htmlFor="e5" title="Outstanding">
                          5
                        </label>
                        <div className="hr-line"></div>
                        ...
                        <input
                          ...
                          value="4"
                        />
                        <label htmlFor="e4" title="Very Good">
                          4
                        </label>
                        <div className="hr-line"></div>
                        ...
                        <input
                          ...
                          value="1"
                        />
                        <label htmlFor="e1" title="Very Poor">
                          1
                        </label>
                      </fieldset>
                    </div>
                  ...
                  <div className="product margin-large">
                    ...
                    <div className="product-rating">
                      <input
                        type="checkbox"
                        onChange={this.handleChange}
                        id="accurate-timekeeping"
                        name="productStandouts"
                        value="Accurate Timekeeping"
                      />
                      <label
                        htmlFor="accurate-timekeeping"
                        className={
                          "productRatingLabel " +
                          (this.state.productStandouts.length === 5
                            ? "disabled"
                            : "")
                        }
                      >
                      ...
                      <input
                        type="checkbox"
                        onChange={this.handleChange}
                        id="attracts-compliments"
                        name="productStandouts"
                        value="Attracts Compliments"
                      />
                      <label
                        htmlFor="attracts-compliments"
                        className={
                          "productRatingLabel " +
                          (this.state.productStandouts.length === 5
                            ? "disabled"
                  ...
                  <div className="about margin-small">
                    ...
                    <span
                      className={
                        this.state.errors.age.length > 0 ? "empty-field" : ""
                      }
                    >
                      Age range
                    </span>
                    ...
                    <div className="age-groups">
                      <input
                        ...
                        value="Under 18"
                      />
                      <label htmlFor="ageGroup1" className="ageGroupLabel">
                        Under 18
                      </label>
                      ...
                      <input
                        ...
                        value="18 - 24"
                      />
                      <label htmlFor="ageGroup2" className="ageGroupLabel">
                        18 - 24
                      </label>
                      ...
                      <input
                        ...
                        value="25 - 34"
                      />
                      <label htmlFor="ageGroup3" className="ageGroupLabel">
                        25 - 34
                      </label>
                      ...
                      <input
                        ...
                        value="35 - 44"
                      />
                      <label htmlFor="ageGroup4" className="ageGroupLabel">
                        35 - 44
                      </label>
                      ...
                      <input
                        ...
                        value="45 - 54"
                      />
                      <label htmlFor="ageGroup5" className="ageGroupLabel">
                        45 - 54
                      </label>
                      ...
                      <input
                        ...
                        value="55 - 64"
                      />
                      <label htmlFor="ageGroup6" className="ageGroupLabel">
                        55 - 64
                      </label>
                      ...
                      <input
                        ...
                        value=" 65+"
                      />
                      <label htmlFor="ageGroup7" className="ageGroupLabel">
                        {" "}
                        65+
                      </label>
                    </div>
                  ...
                  <div className="boughtFor margin-small">
                    <span
                      className={
                        this.state.errors.reason.length > 0 ? "empty-field" : ""
                      }
                    >
                      Bought For
                    </span>
                    ...
                    <div className="buying-reasons">
                      ...
                      />
                      <label
                        htmlFor="buyingReason1"
                        className="buyingReasonLabel"
                      >
                        Personal Use
                      </label>
